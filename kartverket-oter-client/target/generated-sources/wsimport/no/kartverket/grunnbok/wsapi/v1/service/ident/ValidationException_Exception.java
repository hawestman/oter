 ...
 * 
 */
@WebFault(name = "ValidationException", targetNamespace = "http://kartverket.no/grunnbok/wsapi/v1/service/ident")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: no.kartverket.grunnbok.wsapi.v1.service.ident.ValidationException
     */
